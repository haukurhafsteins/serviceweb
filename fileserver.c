...
bool serviceweb_fileserver_start(const char *base_path)
{
    ...
    httpss_register_url("/*", false, download_get_handler, HTTP_GET, server_data);
    httpss_register_url("/upload/*", false, upload_post_handler, HTTP_POST, server_data);
    httpss_register_url("/delete/*", false, delete_post_handler, HTTP_POST, server_data);
